 ...
 */
export async function devAutoLogin(userType: 'admin' | 'superadmin' = 'superadmin') {
  ...
  try {
    ...
    console.log(`🔑 JWT Token:`, data.session?.access_token?.substring(0, 50) + '...');
...
if (typeof window !== 'undefined' && process.env.NODE_ENV === 'development') {
  ...
  console.log('🛠️  Development user switcher available globally as window.devUserSwitcher');
